...
class WorkflowNodeCreate(BaseModel):
    ...
    sla_config: Optional[Dict[str, Any]] = Field(None, description="Structured SLA: {value, unit (SECONDS|MINUTES|HOURS|CALENDAR_DAYS|BANKING_DAYS), calendar, on_breach (ESCALATE|NOTIFY|REJECT|PROCEED), breach_notify_role}. Overrides sla_days when present.")
