# 4. The Canva Studio & AI Ecosystem
...
graph TD
    subgraph AI_Layer [AI Layer]
        AI_Assistant["Infinity AI Assistant </br> (Natural Language Command)"]
        Behavioral_AI["Behavioral AI Engine </br> (Builds User Profiles)"]
    end

    subgraph Canva_Studios [API-Driven Canva Studios </br> (Defines Logic-as-Data)]
    ...
    subgraph Execution_Engines [Stateless Execution Engines]
    ...
    Orchestrator -- "Broadcasts Events to" --> Event_Repo
    
    BRE -- "Can Invoke" --> CE
    
    Insight_Designer -- "Defines Analysis Steps for" --> Orchestrator
    
    Event_Repo -- "Can Trigger" --> Workflow_Designer
    Event_Repo -- "Can Trigger" --> Rule_Designer
    Event_Repo -- "Can Trigger" --> Insight_Designer
```